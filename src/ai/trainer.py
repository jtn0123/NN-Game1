...
class Trainer:
    ...
    def __init__(self, game, agent, config: Optional[Config] = None, visualizer=None):
        """
    ...
    def train(
        ...
        # Final save
        self.agent.save(os.path.join(self.config.MODEL_DIR, f"{self.config.GAME_NAME}_final.pth"))
