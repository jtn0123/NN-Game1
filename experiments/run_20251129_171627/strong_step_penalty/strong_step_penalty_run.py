#!/usr/bin/env python3
"""Auto-generated experiment: strong_step_penalty"""
import os
import sys
...
# Setup paths
experiment_name = "strong_step_penalty"
...
print(f"{'Stronger step penalty: -0.02 (was -0.01)'}")
print(f"============================================================\n")
