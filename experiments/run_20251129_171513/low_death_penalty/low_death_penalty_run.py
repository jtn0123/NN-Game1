#!/usr/bin/env python3
"""Auto-generated experiment: low_death_penalty"""
import os
import sys
...
config = Config()
overrides = {"SI_REWARD_PLAYER_DEATH": -1.0}
...
# Setup paths
experiment_name = "low_death_penalty"
...
print(f"{'Lower death penalty: -1.0 (was -2.5)'}")
print(f"============================================================\n")
