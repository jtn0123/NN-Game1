#!/usr/bin/env python3
"""Auto-generated experiment: aggressive_combo"""
import os
import sys
...
config = Config()
overrides = {"SI_REWARD_SHOOT": 0.05, "SI_REWARD_STAY": -0.05}
...
# Setup paths
experiment_name = "aggressive_combo"
output_dir = "experiments/run_20251129_171513"
...
print(f"{'Combo: high shoot +0.05, high stay penalty -0.05'}")
print(f"============================================================\n")
